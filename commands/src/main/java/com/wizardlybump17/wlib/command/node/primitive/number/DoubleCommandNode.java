...
public class DoubleCommandNode extends NumberCommandNode<Double> implements PrimitiveCommandNode {
    ...
    public DoubleCommandNode(@NotNull String name, @NotNull List<CommandNode<?>> children, @NotNull AllowedInputs<Double> allowedInputs, @Nullable Suggester<Double> suggester, @Nullable CommandNodeExecutor<?> executor, @Nullable String permission) {
