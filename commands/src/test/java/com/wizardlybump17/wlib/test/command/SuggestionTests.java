...
class SuggestionTests {
    ...
    void testSuccess0() {
        ...
        List<String> actual = Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of()));
    ...
    void testSuccess1() {
        ...
        List<String> expected = List.of("hello");
        List<String> actual = Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("he")));
    ...
    void testSuccess2() {
                ...
                new LiteralCommandNode(
                        ...
                        List.of(
                                ...
                                new LiteralCommandNode(
                                        "there",
                                        List.of(),
                                        context -> CommandResult.successful("hello there"),
                                        null
                                )
                        ),
                        null,
        ...
        List<String> actual = Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "")));
    ...
    void testSuccess4() {
                ...
                new LiteralCommandNode(
                        ...
                        List.of(
                                ...
                                new LiteralCommandNode(
                                        "happy",
                                        List.of(),
                                        context -> CommandResult.successful("hello happy"),
                                        null
                                )
                        ),
                        null,
        ...
        List<String> actual = Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "h")));

        Assertions.assertEquals(expected, actual);
    }

    @Test
    void testDefaultLiteral() {
        Command command = new Command(
                new LiteralCommandNode(
                        "hello",
                        List.of(),
        ...
        Assertions.assertEquals(
                List.of("hello"),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of()))
        );
        Assertions.assertEquals(
                List.of("hello"),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("")))
        ...
        Assertions.assertEquals(
                List.of("hello"),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hel")))
        );
    }
    ...
    void testDefaultByte() {
        ...
        Assertions.assertEquals(
                ...
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "")))
        );
        Assertions.assertEquals(
                List.of("-128", "-100", "-50", "0", "50", "100", "127"),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "0")))
        );
        Assertions.assertEquals(
                List.of("-128", "-100", "-50", "0", "50", "100", "127"),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "10")))
        );
    }
    ...
    void testDefaultString() {
        ...
        Assertions.assertEquals(
                List.of("\"wo\""),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "wo")))
        );
        Assertions.assertEquals(
                List.of("\"spaced \""),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "spaced ")))
        );
        Assertions.assertEquals(
                List.of("\"spaced string\""),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "spaced string")))
        );
    }
    ...
    void testDefaultUUID() {
        ...
        Assertions.assertEquals(
                List.of("9b07bd8a-a4c0-3681-997f-6b6df78c0abe", "2931e955-084c-3d9e-aea4-8e5c2c1089c1", "2931e955-084c-3d9e-aea4-8e5c2c1089c1"),
                Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "9b07bd8a-a4c0")))
        );
    }
    ...
    void testEmptyStrings0() {
        ...
        Assertions.assertEquals(List.of("world"), Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", ""))));
        Assertions.assertEquals(List.of(), Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "", ""))));
    }
    ...
    void testEmptyStrings1() {
        ...
        Assertions.assertEquals(List.of("world"), Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", ""))));
        Assertions.assertEquals(List.of(), Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "", ""))));
        Assertions.assertEquals(List.of("test0"), Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "world", ""))));
        Assertions.assertEquals(List.of(), Assertions.assertDoesNotThrow(() -> commandManager.getSuggestions(CHAD_SENDER, List.of("hello", "world", "test0", ""))));
    }
}