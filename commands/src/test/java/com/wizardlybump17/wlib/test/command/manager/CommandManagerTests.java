...
class CommandManagerTests {
    ...
    void testRegisterDifferent() {
        Command command0 = new Command(
                new LiteralCommandNode(
                        "hello0",
                        List.of(),
                        context -> CommandResult.successful("hello0"),
                        "permission"
                )
        );
        Command command1 = new Command(
                new LiteralCommandNode(
                        "hello1",
                        List.of(),
                        context -> CommandResult.successful("hello1"),
                        "permission"
                )
        );
        Command command2 = new Command(
                new LiteralCommandNode(
                        "hello2",
                        List.of(),
                        context -> CommandResult.successful("hello2"),
                        "permission")
        );
        Command command3 = new Command(
                new LiteralCommandNode(
                        "hello3",
                        List.of(),
                        context -> CommandResult.successful("hello3"),
                        "permission"
                )
        );
    ...
    void testRegisterMerging0() {
        CommandNodeExecutor<?> helloExecutor = context -> CommandResult.successful("hello");
        CommandNodeExecutor<?> helloWorldExecutor = context -> CommandResult.successful("hello world");
        CommandNodeExecutor<?> helloWorldHiExecutor = context -> CommandResult.successful("hello world hi");
    ...
    void testRegisterMerging1() {
        ...
        CommandNodeExecutor<?> helloWorldExecutor = context -> CommandResult.successful("hello world");
        CommandNodeExecutor<?> helloWorldHiExecutor = context -> CommandResult.successful("hello world hi");
        CommandNodeExecutor<?> helloThereExecutor = context -> CommandResult.successful("hello there");
    ...
    void testCommandNotFound0() {
        ...
        Assertions.assertEquals(
                CommandResult.Errors.commandNotFound("hello0"),
    ...
    void testSuccess0() {
        ...
        Command command1 = new Command(
                new LiteralCommandNode(
                        "hi",
                        List.of(),
                        context -> CommandResult.successful("hi"),
                        "permission"
                )
        );
        Command command2 = new Command(
        ...
        CommandResult<String> expected = CommandResult.successful("hello");
    ...
    void testSuccess1() {
        ...
        CommandResult<String> expected = CommandResult.successful("hi there");
