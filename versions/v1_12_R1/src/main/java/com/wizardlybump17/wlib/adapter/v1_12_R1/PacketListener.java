...
public class PacketListener extends PacketAdapter {
    ...
    private boolean isInvalid(ItemStack itemStack) {
        final net.minecraft.server.v1_12_R1.ItemStack copy = CraftItemStack.asNMSCopy(itemStack);
    ...
    public void entityEquipment(PacketPlayOutEntityEquipment handle) {
        ...
        net.minecraft.server.v1_12_R1.ItemStack item = (net.minecraft.server.v1_12_R1.ItemStack) field.get(handle);
    ...
    private void setSlot(PacketPlayOutSetSlot packet) {
        ...
        final net.minecraft.server.v1_12_R1.ItemStack stack = ((net.minecraft.server.v1_12_R1.ItemStack) field.get(packet)).cloneItemStack();
